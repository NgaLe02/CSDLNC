...
const PhongBanPage: React.FC = () => {
  const [listData, setListData] = useState<PhongBanModel[]>([]);
  const [showForm, setShowForm] = useState(false);
  const [editingModel, setEditingModel] = useState<PhongBanModel>(
    new PhongBanModel(),
  );
  ...
  function handleAdd() {
    setEditingModel(new PhongBanModel());
    setShowForm(true);
  }
      ...
      <div className="container-fluid pt-4 px-4">
        <div className="bg-light text-center rounded p-4">
          <div className="d-flex align-items-center justify-content-between mb-4">
            <h6 className="mb-0">Danh sách Phòng ban</h6>

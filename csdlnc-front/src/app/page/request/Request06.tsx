...
export default function Request06() {
  ...
  useEffect(() => {
    getTimeBaoDuongQuaHan();
  }, [modelSearch.time]);

  function getTimeBaoDuongQuaHan() {
    RequestService.getInstance()
      .getTimeBaoDuongQuaHan(modelSearch)
      .then((response) => {
      ...
      <div className="container-fluid pt-4 px-4">
        <div className="bg-light text-center rounded p-4">
          <div className="d-flex align-items-center justify-content-between mb-4">
            <h6 className="mb-0">Quá hạn bảo dưỡng</h6>
          </div>
